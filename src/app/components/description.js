...
export default function Description() {
    return (
      <section id="description" className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:px-8">
          ...
          <figure className="mt-10">
            ...
            <figcaption className="mt-10">
              ...
              <div className="mt-4 flex items-center justify-center space-x-3 text-base">
                <div className="font-semibold text-gray-900">Isaac Luisjuan</div>
                <svg viewBox="0 0 2 2" width={3} height={3} aria-hidden="true" className="fill-gray-900">
                  <circle cx={1} cy={1} r={1} />
                </svg>
                <div className="text-gray-600">Full-Stack Developer Node | Next</div>
              </div>
            </figcaption>
          </figure>
        </div>
