    ...
    <section id="portfolio" style={{ background: "#151515" }}>
      <div className="container px-6 py-10 mx-auto">
        <h1 className="text-3xl font-semibold text-center capitalize relative">
          <span className="text-white bg-clip-text hover:text-4xl">
            Portfolio
          </span>
        </h1>

        <p className="mt-4 text-center text-gray-200">
          Welcome to the project gallery. Below I present a selected sample of
          my most recent works, each of which signifies a commitment to
          continuous learning and improving the quality of my software.
        </p>

        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
          {portafolioItems?.map((proyect) => (
            <div key={proyect.name} className={styles.portfolio}>
              <div
              ...
              >
                <div className="flex flex-col justify-center w-full h-full px-8 py-4 transition-opacity duration-700 opacity-0 backdrop-blur-sm bg-gray-900/70 group-hover:opacity-100">
                  ...
                  <h2 className="mt-2 text-lg font-normal font-sans text-white ">
                    {proyect.description}
                  </h2>
                  ...
                  <a
                    href={proyect.code}
                    className="mt-2 text-lg tracking-wider font-semibold text-blue-500 uppercase hover:text-blue-900 cursor-pointer"
                  >
                    Code
                  </a>
                  <a
